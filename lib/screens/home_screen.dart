...
import 'package:pinfo/models/filter.dart';
import 'package:pinfo/models/notes.dart';
...
class _HomeScreenState extends State<HomeScreen> with CommandHandler {
          ...
          child: Consumer2<NoteFilter, List<Note>>(
            builder: (context, filter, notes, child) {
              ...
              return Scaffold(
                    ...
                    child: CustomScrollView(
                      slivers: [
                        ...
                        if (hasNotes) SliverToBoxAdapter(
                          child: SizedBox(height: (canCreate
                              ? kBottomBarSize
                              : 10) + 10,),
                ...
                bottomNavigationBar: canCreate ? _bottomAction() : null,
                extendBody: true,
              );
            },
          ),
  ...
  Widget _appBar(BuildContext context, NoteFilter filter, Widget bottom) =>
      filter.noteState < NoteState.archived ? SliverAppBar(
        floating: true,
        snap: true,
